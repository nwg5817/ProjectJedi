...
{
    public class Verb_CastPawnAbility : Verb_LaunchProjectile
    {
        public VerbProperties_PawnAbility warpverbprops
        {
            get
            {
                return (VerbProperties_PawnAbility)verbProps;
            }
        }

        public ProjectileDef_PawnAbility warpProjectileDef
        {
            get
            {
                return this.warpverbprops.projectileDef as ProjectileDef_PawnAbility;
            }
        }
